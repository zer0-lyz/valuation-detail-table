...
2. **poppler不可用时MUST配置PATH**：
   - Skill已内置预编译Windows二进制包 `scripts/Release-26.02.0-0/poppler-26.02.0/Library/bin/`（含pdftoppm.exe）
...
import sys
sys.path.insert(0, r'C:\Users\Administrator\.workbuddy\skills\valuation-common\scripts')
